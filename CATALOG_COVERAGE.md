...
- 本番 12件 / ヨドバシ販売確認済み・本番仕様照合待ち 8件 / ヨドバシ確認待ち 1件
- **次の本番仕様照合:** `R-WXC74X`, `R-GXCC67X`, `R-GZC67X`, `R-HZC62Y`, `R-HXCC62X`, `R-HZC54Y`, `R-HXCC54X`, `R-H49Y`
- **販売確認継続:** `R-H54Y`
...
- 日立: 初回台帳化済み。未昇格8機種の公式仕様照合とR-H54Yの販売確認を優先
- **東芝: 日立昇格完了後に着手**
- SHARP
- AQUA

### 優先B: 未登録シリーズの本番昇格
- 日立: WXC / GXCC / GZC / HZC / HXCC / H の未登録現行シリーズを優先
