...
- 本番 21件 / 販売確認済み・本番仕様照合待ち 6件 / ヨドバシ確認待ち 0件
- batch 10で `MR-WXD47LN`, `MR-BD46N/BD46NL`, `MR-MD45N/MD45NL`, `MR-C33M` を本番昇格
- **次の本番仕様照合:** `MR-WZ55N`, `MR-JW55N`, `MR-JM54N`, `MR-GW52N`, `MR-JW50N`, `MR-JM49N`
...
- Panasonic: 初回台帳化済み
- 三菱電機: 発売済み現行候補の初回台帳化・ヨドバシ販売確認まで完了
- 日立: 次に着手
- 東芝
- SHARP
- AQUA
...
### 優先B: 未登録シリーズの本番昇格
- 三菱電機: `MR-WZ55N`, `MR-JW55N`, `MR-JM54N`, `MR-GW52N`, `MR-JW50N`, `MR-JM49N` の公式仕様を全項目照合後に昇格
